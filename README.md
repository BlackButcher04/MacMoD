...
3. Make sure the database connection password in each .py file is password="" .
...
For inquiry: 
Please contact 
1. Email (Jun Hwa): ljhwa2004@gmail.com (For setup inquiry).
2. Email (Hoe Yien): hoeyien1010@gmail.com(For usage inquiry).
3. Email (Huey Lym): yunatan535@gmail.com(For MacMoD friendly feedback).
